...
//   public abstract userEmail: string;
//   public abstract emailValidation(email: string): void;
// }
...
//   public emailValidation(userEmail: string): void {
...
// console.log(new Person("Mark", "thb"));
